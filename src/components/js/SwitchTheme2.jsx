...
const changeTheme = (pre, curr) => {
  ...
  document.getElementById('switcher_theme2').classList.remove(pre)
  document.documentElement.classList.add(curr)
  document.getElementById('switcher_theme2').classList.add(curr)
}
const changeTypo = (pre, curr) => {
  document.documentElement.classList.remove(pre)
  document.getElementById('switcher_typo2').classList.remove(pre)
  document.documentElement.classList.add(curr)
  document.getElementById('switcher_typo2').classList.add(curr)
}

export const SwitchTheme2 = () => {
  const switchTheme = () => {
  ...
  return (
    <>
      <div className="switcher disabled theme" onClick={switchTheme}>
        <div id="switcher_theme2" className="theme1"></div>
      </div>
      <div className="switcher disabled typo" onClick={switchTypo}>
        <div id="switcher_typo2" className="typo1"></div>
      </div>
    </>
  )
}
